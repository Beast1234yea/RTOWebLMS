...
namespace RTOWebLMS.Components;

/// <summary>
/// Authentication state provider that integrates ASP.NET Core Identity with Blazor Server
/// Revalidates the authentication state to ensure it's in sync with Identity cookies
/// </summary>
